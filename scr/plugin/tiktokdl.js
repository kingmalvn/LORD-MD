          ...
          message: {
            ...
            interactiveMessage: proto.Message.InteractiveMessage.create({
              body: proto.Message.InteractiveMessage.Body.create({
                text: `𝚁𝙰𝚅𝙴𝙽𝚂 𝙼𝙳 Tiktok 𝙳𝙾𝚆𝙽𝙻𝙾𝙰𝙳𝙴𝚁\n\n𝚃𝙸𝚃𝙻𝙴: ${currentResult.data.title}\nAuthor: ${currentResult.data.author.nickname}\nViews: ${currentResult.data.view}\nDuration: ${currentResult.data.duration}s\n`
              }),
              footer: proto.Message.InteractiveMessage.Footer.create({
                text: "© ᴘᴏᴡᴇʀᴇᴅ ʙʏ ʟᴏʀᴅ ᴍᴀʟᴠɪɴ"
              }),
              header: proto.Message.InteractiveMessage.Header.create({
                 ...(await prepareWAMessageMedia({ image: { url: `https://files.catbox.moe/w5doyr.png` } }, { upload: Matrix.waUploadToServer })),
                title: "",
                gifPlayback: true,
                subtitle: "",
      ...
      if (selectedMedia) {
        try {
          ...
          if (type === 'video' && fileSizeInMB <= 300) {
            content = { video: finalMediaBuffer, mimetype: 'video/mp4', caption: '> © ᴘᴏᴡᴇʀᴇᴅ ʙʏ ʟᴏʀᴅ ᴍᴀʟᴠɪɴ' };
          } else if (type === 'audio' && fileSizeInMB <= 300) {
            content = { audio: finalMediaBuffer, mimetype: 'audio/mpeg', caption: '> © ᴘᴏᴡᴇʀᴇᴅ ʙʏ ʟᴏʀᴅ ᴍᴀʟᴠɪɴ' };
          }
