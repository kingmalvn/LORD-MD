...
const { delay, loading, react } = require("../lord/utils");
...
// bug database
const { bugtext1 } = require("../lord/bugs/bugtext1");
const { bugtext2 } = require("../lord/bugs/bugtext2");
const { bugtext3 } = require("../lord/bugs/bugtext3");
const { bugtext4 } = require("../lord/bugs/bugtext4");
const { bugtext5 } = require("../lord/bugs/bugtext5");
const { bugtext6 } = require("../lord/bugs/bugtext6");
const { bugpdf } = require("../lord/bugs/bugpdf.js");
    ...
    async (dest, zk, commandOptions) => {
        ...
        const bug = {
            orderMessage: {
                ...
                sellerJid: "263780166288@s.whatsapp.net",
