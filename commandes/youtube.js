...
zokou({
  ...
  caption: `╭━━𝚁𝙰𝚅𝙴𝙽𝚂 𝙼𝙳 𝙳𝙾𝚆𝙽𝙻𝙾𝙰𝙳𝙴𝚁 𝙼𝙴𝙽𝚄━━╮
...
Views: ${videos[0].views}`,
  ...
  whatsapp: "Join my WhatsApp channel: https://whatsapp.com/channel/0029Vac8SosLY6d7CAFndv3Z'"
};
...
_*Downloading...*_`
      ...
      fileStream.on('finish', () => {
        ...
        zk.sendMessage(origineMessage, { video: { url :"./video.mp4"} , caption: "*𝗥𝗔𝗩𝗘𝗡𝗦 𝗠𝗗", gifPlayback: false }, { quoted: ms });
      });
