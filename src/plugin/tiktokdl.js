          ...
          message: {
            ...
            interactiveMessage: proto.Message.InteractiveMessage.create({
              body: proto.Message.InteractiveMessage.Body.create({
                text: `𝙻𝙾𝚁𝙳 𝙼𝙳 𝚃𝚒𝚔𝚃𝚘𝚔 𝙳𝚘𝚠𝚗𝚕𝚘𝚊𝚍\n\n𝚃𝚒𝚝𝚕𝚎: ${currentResult.data.title}\n𝙰𝚞𝚝𝚑𝚘𝚛: ${currentResult.data.author.nickname}\n𝚅𝚒𝚎𝚠𝚜: ${currentResult.data.view}\n𝙳𝚞𝚛𝚊𝚝𝚒𝚘𝚗: ${currentResult.data.duration}s\n`
              }),
      ...
      if (selectedMedia) {
        try {
          ...
          if (type === 'video' && fileSizeInMB <= 300) {
            content = { video: finalMediaBuffer, mimetype: 'video/mp4', caption: '> © ᴘᴏᴡᴇʀᴇᴅ ʙʏ 𝙻𝙾𝚁𝙳 𝙼𝙳' };
          } else if (type === 'audio' && fileSizeInMB <= 300) {
            content = { audio: finalMediaBuffer, mimetype: 'audio/mpeg', caption: '> © ᴘᴏᴡᴇʀᴇᴅ ʙʏ 𝙻𝙾𝚁𝙳 𝙼𝙳' };
          }
